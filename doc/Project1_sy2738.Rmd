...
```{r word/structure length, echo=FALSE, message=FALSE, warning=FALSE}
p1 <- ggplot(spooky) +
...
```{r pos freq+prop, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r EAP word cloud, echo=FALSE, message=FALSE, warning=FALSE}
...
##### Word Cloud of HPL
```{r HPL word cloud, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r MWS word cloud, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r cor plot(freq+prop), echo=FALSE, message=FALSE, warning=FALSE}
